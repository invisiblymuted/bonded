...
const AuthChoice = () => {
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-[#f0ede4] via-[#f0ede4] to-[#f0ede4] flex flex-col">
      <Header />
      ...
      <main className="flex-1 pt-24 pb-20 px-4 flex items-center justify-center">
        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <Link href="/signup" className="block h-full">
            <div className="h-full min-h-[320px] flex flex-col items-center justify-center p-12 sm:p-14 md:p-16 bg-white border-2 border-[#f0ede4] rounded-3xl hover:border-[#2458a0] hover:shadow-2xl transition-all cursor-pointer group">
