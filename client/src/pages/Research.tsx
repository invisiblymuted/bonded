          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="bg-white border-[#dcd7ca] p-8 rounded-3xl shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="mb-4">
                  <p className="text-3xl font-black bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">
                    1.2M+
                  </p>
                  <p className="text-xs text-[#4a453e] opacity-60 font-bold mt-1">Cases annually reported globally</p>
                </div>
                ...
                <ul className="space-y-2 text-xs text-[#4a453e] opacity-80">
              ...
              <Card className="bg-white border-[#dcd7ca] p-8 rounded-3xl shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="mb-4">
                  <p className="text-3xl font-black bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">
                    400K+
                  </p>
                  <p className="text-xs text-[#4a453e] opacity-60 font-bold mt-1">Military children in active separations</p>
                </div>
                <p className="text-sm text-[#4a453e] leading-relaxed mb-4">
              ...
              <Card className="bg-white border-[#dcd7ca] p-8 rounded-3xl shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="mb-4">
                  <p className="text-3xl font-black bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">
                    5.1M
                  </p>
                  <p className="text-xs text-[#4a453e] opacity-60 font-bold mt-1">Children with incarcerated parents</p>
                </div>
                <p className="text-sm text-[#4a453e] leading-relaxed mb-4">
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {categories.map((cat, i) => (
                <Card key={i} className="bg-white border-[#dcd7ca] p-8 h-full flex flex-col justify-between shadow-sm rounded-3xl transition-all hover:border-[#f26522]/40 hover:shadow-md">
                  <div>
                    ...
                    <p className="text-sm text-[#4a453e] font-bold leading-relaxed mb-8">
                      {cat.desc}
                    </p>
                  ...
                  <Link href={cat.link}>
                    <div className="text-xs font-black text-[#2458a0] flex items-center gap-2 cursor-pointer hover:text-[#f26522] hover:gap-3 transition-all uppercase tracking-widest pt-8 mt-6 border-t border-[#f0ede4]">
                      Explore {cat.title} <ExternalLink className="h-4 w-4" />
                    </div>
                  </Link>
                </Card>
              ))}
